...
final class LegacyCrypto: LegacyCryptoProtocol {
    ...
    private let symmetricKeyProvider: SymmetricKeyProviding
    
    init(symmetricKeyProvider: SymmetricKeyProviding) {
        self.symmetricKeyProvider = symmetricKeyProvider
    }

    func encryptPhotoLegacy(_ data: Data) throws -> Data {
        let keyData = try symmetricKeyProvider.retrieveSymmetricKeyData()
